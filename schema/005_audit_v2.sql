-- Позвоночник: одна строка на (node, ray, phase). Форма записи — схема
-- модуля, docs/messages/agent.schema.ts. Две фазы одного HTTP-запроса — две
-- строки, поэтому phase в ключе.
--
